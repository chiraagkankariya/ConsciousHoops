...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://conscioushoops.com" },
      { property: "og:image", content: "https://conscioushoops.com/og-preview.png" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "Where the court meets the mind." },
      ...
      { name: "twitter:image", content: "https://conscioushoops.com/og-preview.png" },
